-- ================================================
-- Correção Simples: Feed da Comunidade
-- Versão simplificada que evita problemas de tipo
-- ================================================
...
-- 7. Inserir transações existentes no community_feed (versão simplificada)
INSERT INTO public.community_feed (
    user_id,
    user_display_name,
    user_username,
