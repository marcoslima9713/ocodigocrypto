...
-- 4. Inserir transações uma por uma para evitar erros de sintaxe
-- Transação 1: BTC
...
SELECT gen_random_uuid(), id, 'BTC', 'buy', 0.1, 45000, 4500, NOW() - INTERVAL '30 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 2: BTC
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'BTC', 'buy', 0.05, 44000, 2200, NOW() - INTERVAL '25 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 3: BTC
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'BTC', 'buy', 0.08, 46000, 3680, NOW() - INTERVAL '20 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 4: ETH
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'ETH', 'buy', 1.5, 3000, 4500, NOW() - INTERVAL '28 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 5: ETH
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'ETH', 'buy', 0.8, 3100, 2480, NOW() - INTERVAL '22 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 6: SOL
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'SOL', 'buy', 25, 100, 2500, NOW() - INTERVAL '26 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 7: SOL
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'SOL', 'buy', 15, 110, 1650, NOW() - INTERVAL '18 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 8: ADA
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'ADA', 'buy', 2000, 0.5, 1000, NOW() - INTERVAL '24 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 9: ADA
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'ADA', 'buy', 1500, 0.48, 720, NOW() - INTERVAL '15 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 10: DOT
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'DOT', 'buy', 100, 8, 800, NOW() - INTERVAL '21 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';

-- Transação 11: DOT
INSERT INTO public.transactions (id, user_id, crypto_symbol, transaction_type, amount, price_usd, total_usd, transaction_date, created_at, updated_at)
SELECT gen_random_uuid(), id, 'DOT', 'buy', 50, 8.5, 425, NOW() - INTERVAL '12 days', NOW(), NOW()
FROM public.members WHERE email = 'marcoslima9713@gmail.com';
