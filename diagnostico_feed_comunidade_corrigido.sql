-- ================================================
-- Diagnóstico: Feed da Comunidade (CORRIGIDO)
...
-- 5. Verificar configurações de privacidade do usuário (CORRIGIDO)
SELECT 
...
-- 9. Verificar se o usuário existe em auth.users
SELECT 
...
-- 10. Verificar se o usuário tem configurações de privacidade
SELECT 
    'Configurações de privacidade (detalhado)' as verificação,
    ups.user_id,
    ups.show_in_community_feed,
    ups.created_at,
    ups.updated_at
...
-- 11. Verificar todas as configurações de privacidade
SELECT 
...
-- 12. Verificar todas as entradas no community_feed
SELECT 
