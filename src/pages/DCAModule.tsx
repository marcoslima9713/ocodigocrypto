// Página do Módulo "DCA (Dollar Cost Averaging)"
...
export default function DCAModule() {
  ...
  useEffect(() => {
    ...
    console.log('🔄 Carregando dados do módulo DCA:', currentModuleId);
    ...
    <div className="min-h-screen bg-black">
      ...
      >
        <div className="absolute inset-0">
          <img 
            src={moduleCover || "/dca-cover.jpg"} 
            alt="DCA - Dollar Cost Averaging"
        ...
        <div className="relative z-10 px-4 sm:px-8 lg:px-16 max-w-3xl mt-16">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4">
              {moduleData?.name || 'DCA - Dollar Cost Averaging'}
            </h1>
            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
              {moduleData?.description || 'Domine a estratégia de investimento mais eficaz para acumular Bitcoin ao longo do tempo. Aprenda como o DCA pode reduzir riscos e maximizar seus retornos no mercado de criptomoedas.'}
            </p>
        ...
        >
          ...
          <div className="space-y-4">
            {lessons.length > 0 ? (
              ...
              // Aulas padrão do módulo DCA
              [
                {
                  id: '1',
                  title: 'O que é Dollar Cost Averaging?',
                  description: 'Entenda os fundamentos do DCA e por que é uma das estratégias mais eficazes para investir em Bitcoin.',
                  duration: '15 min',
                  order_index: 1,
                  isCompleted: false
                },
                {
                  id: '2',
                  title: 'Vantagens e Benefícios do DCA',
                  description: 'Descubra como o DCA reduz a volatilidade, elimina o timing do mercado e constrói riqueza a longo prazo.',
                  duration: '18 min',
                  order_index: 2,
                  isCompleted: false
                },
                {
                  id: '3',
                  title: 'Como Implementar DCA na Prática',
                  description: 'Aprenda a criar um plano de DCA personalizado, definir frequência e valores de investimento.',
                  duration: '20 min',
                  order_index: 3,
                  isCompleted: false
                },
                {
                  id: '4',
                  title: 'Melhores Plataformas para DCA',
                  description: 'Conheça as principais exchanges e ferramentas para automatizar seus investimentos DCA em Bitcoin.',
                  duration: '22 min',
                  order_index: 4,
                  isCompleted: false
                },
                {
                  id: '5',
                  title: 'Estratégias Avançadas de DCA',
                  description: 'Explore variações do DCA como Value Averaging, DCA com stop-loss e otimização de timing.',
                  duration: '25 min',
                  order_index: 5,
                  isCompleted: false
                },
                {
                  id: '6',
                  title: 'Analisando Performance do DCA',
                  description: 'Aprenda a acompanhar e analisar o desempenho de sua estratégia DCA ao longo do tempo.',
                  duration: '18 min',
                  order_index: 6,
                  isCompleted: false
                },
                {
                  id: '7',
                  title: 'Psicologia e Disciplina no DCA',
                  description: 'Desenvolva a mentalidade correta para manter consistência e disciplina em sua estratégia DCA.',
                  duration: '16 min',
                  order_index: 7,
                  isCompleted: false
                },
                {
                  id: '8',
                  title: 'DCA vs Outras Estratégias',
                  description: 'Compare o DCA com outras estratégias como lump sum, timing do mercado e trading ativo.',
                  duration: '20 min',
                  order_index: 8,
                  isCompleted: false
                }
          ...
          {completedLessons.length === Math.max(lessons.length, 8) && (
            ...
            >
              ...
              <p className="text-gray-400">
                Você completou todas as aulas do módulo "DCA - Dollar Cost Averaging"
              </p>
            </motion.div>
          )}
        </motion.section>
