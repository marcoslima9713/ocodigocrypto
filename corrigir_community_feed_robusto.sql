-- ================================================
-- Correção Robusta: Feed da Comunidade
-- Resolver todos os problemas de tipo e configuração
-- ================================================

-- 1. Verificar e criar tabelas se necessário
DO $$
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Tabela community_feed já existe';
    END IF;
    ...
    ELSE
        RAISE NOTICE 'Tabela user_privacy_settings já existe';
    END IF;
END $$;
...
-- 9. Verificar especificamente o usuário marcoslima9713@gmail.com
SELECT 
