-- ================================================
-- Diagnóstico: Feed da Comunidade (SEM ERRO)
...
-- 6. Verificar configurações de privacidade do usuário (SEM ERRO)
SELECT 
...
-- 12. Verificar especificamente o usuário marcoslima9713@gmail.com (SEM ERRO)
SELECT 
