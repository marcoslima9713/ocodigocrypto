-- ================================================
-- Correção Final de Tipagem - TEXT vs UUID
-- ================================================

-- 1. Corrigir a função do community_feed
...
-- 2. Corrigir a view do portfolio_rankings
...
-- 4. Recriar o trigger de atualização
