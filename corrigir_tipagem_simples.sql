-- ================================================
-- Correção Simples de Tipagem - TEXT vs UUID
...
-- 2. Corrigir a função do community_feed (versão simplificada)
...
-- 4. Corrigir a view do portfolio_rankings (versão simplificada)
